...
--imgPath = '/home/xinchao/workplace/CEILNet/test_path/floor_data_test_all/left'
--savePath = '/home/xinchao/workplace/CEILNet/saved_path/floor_data_test_done/left'
--imgPath = '/home/xinchao/workplace/CEILNet/daoying_imaegs'
--savePath = '/home/xinchao/workplace/CEILNet/daoying_imaegs_rersult'
imgPath = '/home/xinchao/workplace/CEILNet/virtual_real'
savePath = '/home/xinchao/workplace/CEILNet/virtual_real_save'

model = torch.load('/home/xinchao/workplace/CEILNet/CEILNet_reflection.net')
model = model:cuda()
model:training()
...
for file in paths.files(imgPath) do
  --print 
  if string.find(file,'-input.jpg') then
...
for _,inputFile in ipairs(files) do
  ...
  pred_b = pred_b/255
  local sav = string.gsub(savColor,'input.jpg','predict1.jpg')
  print(sav)
  image.save(sav,pred_b[1])

  pred_r = pred_r/255
  local sav = string.gsub(savColor,'input.jpg','predict2.jpg')
  print(sav)
