...
imgPath = '/home/xinchao/workplace/CEILNet/test_path/office_16'
savePath = '/home/xinchao/workplace/CEILNet/save_path_smooth'

model = torch.load('/home/xinchao/workplace/CEILNet/CEILNet_smooth_L0.net')
model = model:cuda()
model:training()
...
for _,inputFile in ipairs(files) do
  ...
  local sav = string.gsub(savColor,'%-input.jpg','-predict.jpg')
