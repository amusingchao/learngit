...
# import myEnv
import env_final_512laser_numpy_vcontrol00020 as myEnv
import replay_buffer
PI = 3.1415926
ENV_NAME = 'AGV_final_512laser_numpy_vcontrol00020'
        ...
        while True:
            ...
            for idx in endpoint:
                ...
                try:
                    ...
                    action[idx] = agent.get_action(buffer_observation[idx])
                except:
                    print('error')
                #if action[idx]==3:
                  #  print('33:')
